...
<div class="main" >
    <div class="header" >
        <div class="block_header" >
            <div class="logo" ><a href="index.php?module=connexion&action=connexion" ><img src="include/images/logo.png"
                                                                                           width="175" height="97"
                                                                                           border="0" alt="logo" /></a >
            </div >
            <div class="rss" ><a href="#" ><img src="include/images/rss_1.gif" alt="rss" border="0" /></a > <a
                        href="#" ><img src="include/images/rss_2.gif" alt="rss" border="0" /></a > <a href="#" ><img
                            src="include/images/rss_3.gif" alt="rss" border="0" /></a > <a href="#" ><img
                            src="include/images/rss_4.gif" alt="rss" border="0" /></a > <a href="#" ><img
                            src="include/images/rss_5.gif" alt="rss" border="0" /></a > Nous contacter : <br />
                <br />
    ...
    <div class="accord_top" >
        <div id="feature_wrap" >
            <div id="featured" >
                <div class="featured featured1" ><a href="#" ><img id="imgContent" src="include/images/content_12.jpg"
                                                                   alt="screen 1" /></a ></div >
                <div class="featured featured2" ><a href="#" ><img id="imgContent" src="include/images/content_13.jpg"
                                                                   alt="screen 2" /></a ></div >
                <div class="featured featured3" ><a href="#" ><img id="imgContent" src="include/images/content_14.jpg"
                                                                   alt="screen 3" /></a ></div >
                <div class="featured featured4" ><a href="#" ><img id="imgContent" src="include/images/content_15.jpg"
                                                                   alt="screen 4" /></a ></div >
                <div class="featured featured5" ><a href="#" ><img id="imgContent" src="include/images/content_16.jpeg"
                                                                   alt="screen 5" /></a ></div >
            </div >
        </div >
    </div >
        ...
        <div class="body_resize" >
            <div class="right" >
                ...
                <p ><a href="#" >30 Nov 2014</a ><br />
                    ...
                    Mise à jour de différentes fonctionnalités comme les combats, les joueurs ou encore les équipes.
                </p >
                ...
                <p ><a href="#" >22 Nov 2014</a ><br />
                    ...
                    Nous avons fait une réunion d'équipe pour améliorer le jeu. De bonnes idées en sont ressorties.
                </p >
            ...
            <div class="left" >
                ...
                <p >Vous devez vous inscrire pour accéder à notre mini-jeu. Notre site repasse l'actualité l'actualité
                    des jeux vidéos pour vous informer des dernières sorties.</p >

                <p >Nous vous communiquerons les changements qui nous semble nécessaire pour le jeu via les News &
                    Events que vous retrouverez sur votre droite. Vous pouvez aussi accédez aux jeux que nous vous
                    suggerons ci-dessous.. </p >

                <p >&nbsp;</p >

                <h2 >Jeux associes<br />
                    <span > Petite selection de jeu en ligne pour passer un bon moment </span ></h2 >
                <a href="http://www.nicoland.fr/" ><img id="imgJeu" src="include/images/img_11.jpg" alt="img"
                                                        class="floated" /></a > <a href="http://fr.grepolis.com/" ><img
                            id="imgJeu" src="include/images/img_12.jpg" alt="img" class="floated" /></a > <a
                        href="http://www.swtor.com/fr" ><img id="imgJeu" src="include/images/img_13.jpg" alt="img"
                                                             class="floated" /></a ></div >
            <div class="clr" ></div >
        </div >
    </div >
